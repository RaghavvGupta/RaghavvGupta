...
![Typing SVG](https://readme-typing-svg.herokuapp.com?size=18&color=36BCF7&width=900&lines=🚀+Product+Growth+Analyst+|+DevOps+Enthusiast+|+Tech+Blogger+|+Cloud+Engineer)
...
I'm passionate about **Product Growth, DevOps, AI, and Business Analytics**. I thrive on solving challenging problems and optimizing product strategies through data-driven insights. 
...
- **DevOps & Cloud:** AWS (EC2, EKS, ECR, IAM, S3, ELB, EBS) | Docker | Kubernetes | Linux | CI/CD (Jenkins/GitLab)  
- **Version Control:** Git | GitHub | GitLab  

### **📈 Product & Business:**
- Agile | OKRs | SQL | JIRA | Analytics (Mixpanel) | Dashboards (AWS QuickSight)
...
![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=RaghavvGupta&theme=radical)

---

## **🌍 Let's Connect**
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-blue?style=flat&logo=Linkedin&logoColor=white)](https://linkedin.com/in/raghavgupta30)  
[![GitHub](https://img.shields.io/badge/-GitHub-black?style=flat&logo=github&logoColor=white)](https://github.com/RaghavvGupta)  
